...
class MBConvBlock3D(nn.Module):
    ...
    def __init__(self, block_args, global_params):
        ...
        self._swish3 = MemoryEfficientSwish()
    ...
    def forward(self, inputs, drop_connect_rate=None):
        ...
        x = inputs
        if self._block_args.expand_ratio != 1:
            x = self._swish1(self._bn0(self._expand_conv(inputs)))
        x = self._swish2(self._bn1(self._depthwise_conv(x)))

        # Squeeze and Excitation
        if self.has_se:
            x_squeezed = F.adaptive_avg_pool3d(x, 1)
            x_squeezed = self._se_expand(self._swish3(self._se_reduce(x_squeezed)))
...
class EfficientNet3D(nn.Module):
    ...
    def extract_features(self, inputs):
        ...
        # Stem
        x = self._swish1(self._bn0(self._conv_stem(inputs)))
        ...
        # Head
        x = self._swish2(self._bn1(self._conv_head(x)))
